...
export function V2MarketingNav() {
  return (
    <nav className="hidden items-center gap-12 text-sm md:flex lg:gap-16">
      <NavLink to="/landing-v2/expert-network" className={navItemClass}>
        Expert Network
      </NavLink>
      <NavLink to="/landing-v2/solutions" className={navItemClass}>
        Solutions
      </NavLink>
      <NavLink to="/landing-v2/pricing" className={navItemClass}>
        Pricing
      </NavLink>
      <span
