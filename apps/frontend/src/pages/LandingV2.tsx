...
import { V2MarketingFooter } from './V2MarketingFooter'
import { V2MarketingNav } from './V2MarketingNav'

const PARTNER_LOGOS = ['NEXUS.LABS', 'STRATA', 'ORBITAL', 'VECTOR_Q', 'APEX.IO']
...
const FEATURE_CARDS = [
  {
    ...
    desc: 'Access 50,000+ pre-vetted domain experts across 120 countries.',
  },
  {
    title: 'Compliance First',
    desc: 'Integrated IP protection, automated NDAs, and global tax compliance.',
  },
  {
    title: 'Analytics Engine',
    desc: 'Real-time tracking of project health, outcome probability, and ROI metrics.',
  },
]
    ...
    <div className="min-h-screen bg-[#070A12] text-white">
      <header className="sticky top-0 z-20 border-b border-white/10 bg-[#0B0F19]/90 backdrop-blur">
        <div className="flex h-18 w-full items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link to="/landing-v2" className="shrink-0 text-[32px] font-semibold tracking-tight text-[#FFB15A] no-underline">
            Connect
          </Link>
          <V2MarketingNav />
      ...
      <main>
        ...
        <section className="mt-7 border-y border-white/6 bg-[#080C15] py-8">
          <div className="mx-auto max-w-[1200px] px-6">
            <div className="mb-8 grid grid-cols-2 gap-6 text-center text-[28px] font-semibold text-white/45 md:grid-cols-5">
